...
export default function ProductDetail() {
  const { product: dataProduct } = useLoaderData() as { product: Product };
        ...
        <div className="max-w-2xl mx-auto mt-6 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:gap-x-8 lg:px-8">
          <div className="hidden overflow-hidden rounded-lg aspect-h-4 aspect-w-3 lg:block">
            <img
              ...
              alt={dataProduct.description}
              className="object-cover object-center w-full h-full"
            />
          </div>
          <div className="hidden lg:grid lg:grid-cols-1 lg:gap-y-8">
            {dataProduct.images[1] ?? (
              <div className="overflow-hidden rounded-lg aspect-h-2 aspect-w-3">
                <img
                  src={dataProduct.images[1]}
                  alt={dataProduct.description}
                  className="object-cover object-center w-full h-full"
                />
              </div>
            )}
            {dataProduct.images[2] ?? (
              <div className="overflow-hidden rounded-lg aspect-h-2 aspect-w-3">
                <img
                  src={dataProduct.images[2]}
                  alt={dataProduct.description}
                  className="object-cover object-center w-full h-full"
                />
              </div>
          ...
          {dataProduct.images[3] ?? (
            <div className="aspect-h-5 aspect-w-4 lg:aspect-h-4 lg:aspect-w-3 sm:overflow-hidden sm:rounded-lg">
              <img
                src={dataProduct.images[3]}
                alt={dataProduct.description}
                className="object-cover object-center w-full h-full"
              />
            </div>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <div className="flex items-center">
                ...
                <p className="sr-only">{dataProduct.rating} out of 5 stars</p>
                <a
                  href={reviews.href}
